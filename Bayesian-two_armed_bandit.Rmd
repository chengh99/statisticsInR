...
given you won a game playing on Machine 1? (1-0.6 = 0.4)
...
given you won a game playing on Machine 1? (0.4, Good or Bad for machine 1 and 2; mutually exclusive)
...
data1 = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L), 
                   outcome = c("L", "L", "W", "L", "L", "W", "W", "L", "L", "W"))
bandit_posterior(data1)
```
...
data50 = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 1L, 2L), 
                  outcome = c("L", "L", "W", "W", "L", "L", "W", "W", "W", "L", "W", "L", "L", "W", "W", "L", "L", "L", "W", "L", "W", "L", "L", "W", "L", "L", "L", "W", "W", "L", "L", "L", "W", "W", "W", "W", "W", "W", "W", "W", "W", "L", "L", "L", "W", "L", "W", "W", "L", "L"))
# bandit_posterior(data50)
bandit_posterior(data50[1:10,]) %>% 
  bandit_posterior(data50[11:20,], prior = .)
```
...
<div class="question">
From the plot generated in the example above, we can see that the posterior probabilities for Machine 1 and Machine 2 mirror each other. Why will this happen? (Both of the above)
