...
us12_table <- table(us12$response)
us12_table
p_hat <- us12_table[[1]]/us12_table[[2]]
p_hat
```
...
inference(y = response, x = as.factor(year), data = usa, statistic = "proportion", type = "ht", null = 0, success = "atheist", alternative = "twosided", method = "theoretical")
```
